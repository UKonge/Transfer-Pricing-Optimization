# -*- coding: utf-8 -*-
"""
Created on Fri May  7 10:26:26 2021
...
ind += 1
sol.at[ind,'Variable'] = 'Comp Man Profit'
sol.at[ind,'TP_variable'] = sum((n[i])*m.btp_comp[i+1].value-m.btl_comp[i+1].value for i in range(comp_centers))
ind += 1
sol.at[ind,'Variable'] = 'Prod Man Profit'
sol.at[ind,'TP_variable'] = sum((m1[j])*m.btp_fac[j+1].value-m.btl_fac[j+1].value for j in range(fac_centers))
ind += 1
sol.at[ind,'Variable'] = 'Dist Profit'
sol.at[ind,'TP_variable'] = sum((r[k])*m.btp_dist[k+1].value-m.btl_dist[k+1].value for k in range(dist_centers))
##########################################################
##########################################################
##########################################################
...
ind += 1
#sol.at[ind,'Variable'] = 'Comp Man Profit'
sol.at[ind,'TP_fixed_mean'] = sum((n[i])*m.btp_comp[i+1].value-m.btl_comp[i+1].value for i in range(comp_centers))
ind += 1
#sol.at[ind,'Variable'] = 'Prod Man Profit'
sol.at[ind,'TP_fixed_mean'] = sum((m1[j])*m.btp_fac[j+1].value-m.btl_fac[j+1].value for j in range(fac_centers))
ind += 1
#sol.at[ind,'Variable'] = 'Dist Profit'
sol.at[ind,'TP_fixed_mean'] = sum((r[k])*m.btp_dist[k+1].value-m.btl_dist[k+1].value for k in range(dist_centers))
...
ind += 1
#sol.at[ind,'Variable'] = 'Comp Man Profit'
sol.at[ind,'TP_fixed_min'] = sum((n[i])*m.btp_comp[i+1].value-m.btl_comp[i+1].value for i in range(comp_centers))
ind += 1
#sol.at[ind,'Variable'] = 'Prod Man Profit'
sol.at[ind,'TP_fixed_min'] = sum((m1[j])*m.btp_fac[j+1].value-m.btl_fac[j+1].value for j in range(fac_centers))
ind += 1
#sol.at[ind,'Variable'] = 'Dist Profit'
sol.at[ind,'TP_fixed_min'] = sum((r[k])*m.btp_dist[k+1].value-m.btl_dist[k+1].value for k in range(dist_centers))
...
ind += 1
#sol.at[ind,'Variable'] = 'Comp Man Profit'
sol.at[ind,'TP_fixed_max'] = sum((n[i])*m.btp_comp[i+1].value-m.btl_comp[i+1].value for i in range(comp_centers))
ind += 1
#sol.at[ind,'Variable'] = 'Prod Man Profit'
sol.at[ind,'TP_fixed_max'] = sum((m1[j])*m.btp_fac[j+1].value-m.btl_fac[j+1].value for j in range(fac_centers))
ind += 1
#sol.at[ind,'Variable'] = 'Dist Profit'
sol.at[ind,'TP_fixed_max'] = sum((r[k])*m.btp_dist[k+1].value-m.btl_dist[k+1].value for k in range(dist_centers))
